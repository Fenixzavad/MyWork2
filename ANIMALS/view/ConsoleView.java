...
public class ConsoleView implements View {
    ...
    public boolean showAddAnimalDialog() {
        String infoMessage = "Введите параметры животного в виде строки: \"имя День-рождения Род-животного\"\n" +
                "День-рождения имеет вид: dd-mm-yyyy (12-03-2022): \n" +
                "Род-животного может принимать значения: " + Arrays.asList(AnimalGenius.values());
    ...
    private void printRegistryHeader() {
        String header = String.format(COLUMN_HEADER_FORMAT, "№", "Кличка", "Дата рождения", "Возраст(в месяцах)",
                "Род животного");
